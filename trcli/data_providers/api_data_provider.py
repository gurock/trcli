...
from trcli.constants import SYSTEM_NAME_AUTOMATION_ID, WEIRED_SYSTEM_NAME_AUTOMATION_ID
        ...
        for case_updater in case_data:
            matched_case = next(
                (
                    ...
                    for sublist in testcases
                    for case in sublist
                    if case.custom_automation_id == case_updater[SYSTEM_NAME_AUTOMATION_ID]
                ),
                None,
            )
            if matched_case is None:
                matched_case = next(
                    (
                        ...
                        for sublist in testcases
                        for case in sublist
                        if hasattr(case, WEIRED_SYSTEM_NAME_AUTOMATION_ID)
                        and case.custom_case_automation_id == case_updater.get(WEIRED_SYSTEM_NAME_AUTOMATION_ID)
                    ),
                    None,
                )
