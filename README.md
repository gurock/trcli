...
### parse_junit
XML Junit files compatible with Jenkins and pytest reporting schemas
```
...
### Example content of results_file.xml:
```
...
Contributing
============
Interested in contributing and improving the TestRail CLI client? Please start by looking into [CONTRIBUTING.md](https://github.com/gurock/trcli/blob/main/CONTRIBUTING.md).
